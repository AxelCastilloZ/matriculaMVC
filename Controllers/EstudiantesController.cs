...
namespace Matriculas.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Apellido,FechaNacimiento")] Estudiantes estudiantes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Apellido,FechaNacimiento")] Estudiantes estudiantes)
        {
